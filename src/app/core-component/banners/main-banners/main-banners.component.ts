...
declare var $: any; 
@Component({
  selector: 'app-main-banners',
  templateUrl: './main-banners.component.html',
  styleUrls: ['./main-banners.component.scss']
})
...
editdata: any;
  ...
  //get bannerslist
  bannerslist(): void{
    this.api.get(`/main/banners/allmainbanners`).subscribe((res:any)=>{
...
updatebannerstatus(table:any){
  ...
  this.api.post(`/main/banners/${table.id}`, data).subscribe(
    (res: any) => {
...
onSubmit():void{
  ...
  const postdata = new FormData();
    ...
    this.api.post('/main/banners',postdata).subscribe(
      (res: any) => {
        this.toas.success(res.message);
        this.postdata.reset();
        this.bannerslist();
...
singledata(id:any){
  ...
  this.api.get(`/main/banners/${id}`).subscribe((res: any) => {
    this.editdata=res.message;
    // Assuming this.editdata.from_date and this.editdata.to_date are Date objects
...
editSubmit(){
  ...
  this.api.post(`/main/banners/update/${this.editdata.id}`,editeddata).subscribe((res:any)=>{
    this.toas.success(res.message);
    this.editform.reset();
    this.bannerslist();
